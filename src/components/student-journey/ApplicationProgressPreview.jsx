        ...
        return (
          <div key={college.name ?? index}>
            ...
            <div className="relative py-2">
              <div className="relative h-3.5 bg-gray-200 dark:bg-slate-700 rounded-full">
                <div
                  className={`h-full rounded-full bg-gradient-to-r ${colorClass} transition-all duration-700`}
                  style={{ width: `${percent}%` }}
                />
                <div
                  className="absolute top-1/2 w-4 h-4 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white dark:bg-slate-200 border-2 border-gray-300 dark:border-slate-500 shadow-sm pointer-events-none"
                  style={{
