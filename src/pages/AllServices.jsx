...
const FALLBACK = {
  hero: {
    title: "Our Services",
    subtitle:
      "Comprehensive support services for Indian students pursuing education in Germany. From financial solutions to accommodation, we handle everything for your smooth transition."
  },
  stats: [
    { number: "5000+", label: "Forex Cards Issued" },
    { number: "2000+", label: "Accommodations Arranged" },
  ...
  servicesList: [
    {
      ...
      title: "Forex Card & Remittances",
      description:
        "Comprehensive foreign exchange solutions including multi-currency forex cards and international money transfer services with best exchange rates.",
      features: [
        "Multi-Currency Forex Cards",
        "Zero Forex Markup",
        "International Money Transfer",
    ...
    },
    {
      ...
      title: "Accommodation Services",
      description:
        "End-to-end accommodation solutions for students in Germany, from temporary stays to long-term rentals near universities.",
      features: [
        "Student Hostels & Dorms",
        "Shared Apartments (WG)",
        "Studio Apartments",
  ...
  serviceCard: {
    ...
    readyCTA: "Ready to Get Started?",
    ctaDescription:
      "Begin your journey with our comprehensive {serviceTitle} services.",
    learnMore: "Learn More"
  },
  quickStats: {
    studentsLabel: "1000+ Students",
    secureLabel: "100% Secure"
  },
  comprehensiveCTA: {
    heading: "Need Multiple Services?",
    description:
      "Get special package deals when you avail multiple services together. Save time and money with our bundled solutions.",
    packageButton: "Get Package Deal",
    quoteButton: "Custom Quote",
    contactLink: "/contact"
  },
  meta: {
...
// small helper for i18n normalization
...
// icon mapping
const ICONS = { CreditCard, Home, Heart, TrendingUp };
...
const AllServices = () => {
  ...
  const hero = raw.hero || FALLBACK.hero;
  const stats = normalizeArray(raw.stats, FALLBACK.stats);
  const servicesList = normalizeArray(raw.servicesList, FALLBACK.servicesList);
  const card = raw.serviceCard || FALLBACK.serviceCard;
  const quickStats = raw.quickStats || FALLBACK.quickStats;
  const comprehensiveCTA = raw.comprehensiveCTA || FALLBACK.comprehensiveCTA;
      ...
      <section className="relative py-30 overflow-hidden">
        <div className="absolute inset-0">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&w=1920&h=1080&fit=crop')",
              backgroundSize: "cover",
              backgroundPosition: "center"
            }}
          />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-16">
            {servicesList.map((service, index) => {
              const Icon = ICONS[service.icon] || CreditCard;
              return (
                <motion.div
                  key={index}
                  className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden"
                      ...
                      <div className="bg-gradient-to-r from-green-50 to-sky-50 rounded-2xl p-6 border border-green-100">
                        ...
                        <Link to={service.link}>
                          <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                          >
                            {card.learnMore} <ArrowRight className="w-4 h-4" />
                          </motion.button>
                        </Link>
                      </div>
