...
const FALLBACK = {
  hero: {
    ...
    subtitle: 'Hear from students who successfully made it to their dream German universities with our guidance.'
  },
  stats: [
    { number: '4.9/5', label: 'Average Rating' },
    { number: '500+', label: 'Happy Students' },
  ...
  cta: {
    heading: 'Join Our Success Stories',
    sub: 'Become part of a community of motivated students who trusted Profiberater to turn their academic dreams into reality.',
    button: 'Start My Success Journey'
  }
};
...
const Reviews = () => {
  ...
  // read reviews block from i18n (allow returnObjects)
  const raw = t('reviews', { returnObjects: true, defaultValue: {} });
  ...
  const TESTIMONIALS = normalizeArray(raw.testimonials, FALLBACK.testimonials);
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-sky-50 to-green-50">
      ...
      <section className="py-20 bg-gradient-to-r from-green-50 to-sky-50 mt-16">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <motion.button
            className="px-8 py-4 bg-gradient-to-r from-green-600 to-sky-600 text-white font-semibold rounded-xl hover:shadow-lg transition-all duration-300"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            {cta.button}
